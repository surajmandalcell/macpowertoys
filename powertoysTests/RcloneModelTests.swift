...
final class RcloneModelTests: XCTestCase {
    ...
    func testRemoteMetadataCoversKnownAndFallbackProviders() {
        ...
        let box = RcloneRemote(name: "work", type: "box")
        XCTAssertEqual(box.websiteName, "Box")
        XCTAssertEqual(box.websiteFolderURL(id: nil)?.absoluteString, "https://app.box.com/folder/0")
        XCTAssertEqual(box.websiteFolderURL(id: "12345")?.absoluteString, "https://app.box.com/folder/12345")
    ...
    func testRcloneFormatCoversUnitsSpeedEtaAndDuration() {
        ...
        XCTAssertEqual(RcloneFormat.speed(0), "Not available")
        XCTAssertEqual(RcloneFormat.speed(1_024), "1.0 KB/s")
        XCTAssertEqual(RcloneFormat.eta(nil), "Not available")
        XCTAssertEqual(RcloneFormat.eta(.infinity), "Not available")
        ...
        XCTAssertEqual(RcloneFormat.duration(0), "Not available")
