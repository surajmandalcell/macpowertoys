...
The hosted macOS unit-test run [36114412256](https://github.com/surajmandalcell/macpowertoys/actions/runs/36114412256)
passed at `02be189` with 864 passed, five skipped, and zero failures. It ran
...
tests, and saved Portman server, Forward, and Settings attachments. The Forward
and Settings images were inspected in light and dark at the panel's actual
height. The local build-for-testing passed without launching either bundle.
The ad-hoc signed universal Release app and helper passed
`codesign --verify --deep --strict` and embedded tested source revision
`02be189` at build time.
