...
The hosted macOS unit-test run [36117442936](https://github.com/surajmandalcell/macpowertoys/actions/runs/36117442936)
passed at `c225828` with 864 passed, five skipped, and zero failures. It ran
...
overview, Forward, active tunnel, detail, and Settings images were inspected
at the panel's actual hosted height. The chart-axis and cleanup-selection
changes after that run are compile-verified and await a fresh hosted review.
...
`codesign --verify --deep --strict` and embedded `c225828` at build time;
