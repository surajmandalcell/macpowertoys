...
The next hosted run, [36120696699](https://github.com/surajmandalcell/macpowertoys/actions/runs/36120696699),
failed its new unexpected-SSH-exit assertion while the other 863 tests passed
and five were skipped. It drove a real tunnel, then terminated its SSH process;
the service did not show Failed within six seconds. The callback ordering was
