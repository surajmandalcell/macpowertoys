...
| In progress | Use the selected Disk Explorer icon. | The owner chose option 02, Sector platter, from the 20-concept gallery. `spec/icon-refresh-request-list.md` records the production icon and related tool-icon refresh. | Promote the selected artwork to the asset catalog and Raycast command, then check launcher and Dock sizes. |
