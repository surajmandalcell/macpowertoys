...
| Verify | Make charts readable and responsive to interaction. | Treemap hover shows the name, size, and share even for tiny blocks. Rings highlight hovered segments and show names in the center. Chart navigation crossfades and scales, with Reduce Motion support. Run `36138597977` passed focused unit and focus tests; its dark and light renders show shallow rings using the chart height. | Inspect hover and drill behavior in an isolated desktop. |
