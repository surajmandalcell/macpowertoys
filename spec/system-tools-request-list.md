...
|---|---|---|---|
| Verify | Use three destinations: IP Scanner, SSH Anchor, and Network History. | `6b837a6` adds exactly these three sidebar destinations in a compact native workspace. A normal debug build showed all three pages and completed a loopback scan. | Confirm all three pages in the exact installed build. |
