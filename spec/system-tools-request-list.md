...
| Status | Request | Evidence | Remaining work |
|---|---|---|---|
| Done | Use the correct shared width and padding family for every system-tool sidebar. | Input Devices stays in the 220pt compact family; System Care and Power Stats use the 240pt data family. All use the shared 44pt top edge and 12pt horizontal padding. Focused layout tests and the signed `a5ad439` build confirmed all three sidebar families. | None. |
