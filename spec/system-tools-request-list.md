...
| Open | Replace the rejected I21 icon with a clear hardware-mouse icon. | The revised 50-candidate Ox Alpha sheet uses 14 distinct closed mouse constructions across original, Midnight, Porcelain, and Chosen Color treatments. The production `InputDevicesLogoA` asset stays unchanged during selection. | Select one candidate and install it in the shared asset. |
